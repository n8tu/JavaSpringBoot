...
<body>
    ...
    <div class="container w-50">
        ...
        <div class="container d-flex justify-content-between align-items-center">
            <h1 class="display-5 text-primary mt-4">Edit an expense:</h1>
            <a href="/expenses">Go back</a>
        </div>
        <form:form action="/expenses/update/${poke.id}" method="post" modelAttribute="poke">
            <p>
                <input type="hidden" name="_method" value="PUT">
            </p>
            <p>
                <form:label path="expense_name">Expense Name:</form:label>
                <form:input class="form-control" path="expense_name" value="${poke.expense_name}"/>
            </p>
            <p>
                <form:label path="vendor">Vendor:</form:label>
                <form:input class="form-control" path="vendor" value="${poke.vendor}"/>
            </p>
            <p>
                <form:label path="amount">Amount:</form:label>
                <form:input type="number" class="form-control" path="amount" value="${poke.amount}"/>
            </p>
            <p>
                <form:label path="description">Description:</form:label>
                <form:textarea class="form-control" path="description" value="${poke.description}"/>
            </p>
