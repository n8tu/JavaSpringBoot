...
<div class="container w-50">
    ...
    <form:form action="/languages/${language.id}" method="POST" modelAttribute="language">
        <p>
            ...
            <form:input class="form-control" path="name" value="${language.name}"/>
        </p>
        <p>
            <form:label path="creator">Creator:</form:label>
            <form:input class="form-control" path="creator" value="${language.creator}"/>
        </p>
        <p>
            <form:label path="currentVersion">Version:</form:label>
            <form:input class="form-control" path="currentVersion" value="${language.currentVersion}"/>
        </p>
