...
<body onload="addThought()">
    <div class="container w-75 mt-5">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <p class="display-2">Change your Entry</p>
        ...
        <div class="mb-3 w-50">
            ...
            <form:form action="/books/${book.id}/edit" method="POST" modelAttribute="_book">
                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-9">
                        <form:input class="form-control" path="title" value="${book.title}"/>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-9">
                        <form:input class="form-control" path="author" value="${book.author}"/>
                    </div>
                </div>
