...
<div class="container row text-white justify-content-center shadow-lg">
    ...
    <div id="second_section" class="col-5 bg-light text-dark">
        ...
        <div class="container mt-5 row justify-content-center fs-4">
            <p class="my-4 text-center form_label fs-3">Login your account</p>

            <form:form class="w-75 mb-3 row" action="/login" method="POST" modelAttribute="login">
                <div class="mb-3">
                    <form:label path="email" class="form-label form_label">Email</form:label>
                ...
                <a href="/register" class="mb-3 text-center text-decoration-none">
                    <small id="helpId" class="form-text text-muted">Create an account</small>
                </a>
            </form:form>
        </div>
    </div>
